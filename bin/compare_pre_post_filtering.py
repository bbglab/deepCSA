...
"""
Script for comparing mutations before and after filtering.
"""
...
def main(maf_path, somatic_maf):
    ...
    ## show how many mutations are filtered out because they are not in the consensus panel
        ## check if there are many non-synonymous mutations that are filtered out due to this


    ## compare numbers of mutations before and after filtering per gene and per sample

    ## see which specific mutations are filtered out in some samples but kept in others

    ## see which mutations with some value in the HOTSPOT_NAME column are filtered out

    ## plot VAF distortion before and after filtering
