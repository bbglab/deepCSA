...
get_dnds_mut_context = function(muts) {
  ...
  gene_strands = fread("data/bladder/bladder_duplex/refcds/Biomart_Bladder_genes.txt") |> 
...
png("plots/bladder/duplex/dndstrunc_heatmap.png", width = 1800, height = 1800, res = 250)
dndstrunc_heatmap
dev.off()
...
png("plots/bladder/duplex/dndsall_heatmap.png", width = 1800, height = 1800, res = 250)
dndsall_heatmap
dev.off()
...
percent_mutated_plot =
  ...
  theme_bw()
percent_mutated_plot
ggsave("plots/bladder/duplex/percent_of_mutated_cells.png", percent_mutated_plot, width = 6, height = 6)
