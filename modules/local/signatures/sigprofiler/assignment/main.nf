process SIGPROFILERASSIGNMENT {
    ...
    """
    #python -c "from SigProfilerAssignment import Analyzer as Analyze; Analyze.cosmic_fit('${matrix}', 'output_${prefix}', input_type='matrix', context_type='96', signature_database='${reference_signatures}', genome_build='GRCh38', sample_reconstruction_plots= 'pdf', exclude_signature_subgroups=['Chemotherapy_signatures','Immunosuppressants_signatures'])"
    python -c "from SigProfilerAssignment import Analyzer as Analyze; Analyze.cosmic_fit('${matrix}', 'output_${prefix}', input_type='matrix', context_type='96', genome_build='GRCh38', exclude_signature_subgroups=['Chemotherapy_signatures','Immunosuppressants_signatures'])"
