process SIGPROFILERASSIGNMENT {
    ...
    """
    python -c "from SigProfilerAssignment import Analyzer as Analyze; Analyze.cosmic_fit('${matrix}', 'output_${name}', input_type='matrix', context_type='96', genome_build='${assembly}', signature_database='${reference_signatures}' ${exclude_signature_subgroups})"
