...
workflow REGRESSIONS {
    ...
    RUNREGRESSIONSCOHORT(
        metric_name,
        metric_data,
        metric_params,
        params.responses_subset_regressions,
        params.responses_excluded_regressions,
        params.samples_subset_regressions,
        predictors_file,
        params.predictors_plot_config_regressions,
        params.multipletesting_join_regressions,
        params.multivariate_rules_regressions,
    )


    RUNREGRESSIONSIGNORE(
        metric_name,
        metric_data,
        metric_params,
        params.responses_subset_regressions,
